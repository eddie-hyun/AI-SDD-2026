...
| TR-11 | 인증 성공 시 만료 시간이 있는 세션/토큰을 발급하고, 로그아웃 시 즉시 무효화한다 |
...
| FR-10 | 인증된 소유자는 각 섹션의 항목을 삭제할 수 있으며, 삭제 전 확인을 거친다 |
